...
else:symbian: LIBS += -lSOIL
else:unix: LIBS += -L$$PWD/../../../../usr/local/lib/ -lSOIL

INCLUDEPATH += $$PWD/../../../../usr/local/include
DEPENDPATH += $$PWD/../../../../usr/local/include

win32:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../../../usr/local/lib/release/SOIL.lib
else:win32:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../../../usr/local/lib/debug/SOIL.lib
else:unix:!symbian: PRE_TARGETDEPS += $$PWD/../../../../usr/local/lib/libSOIL.a
